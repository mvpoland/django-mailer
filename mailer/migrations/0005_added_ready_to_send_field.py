...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.ready_to_send'
        db.add_column('mailer_message', 'ready_to_send', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.ready_to_send'
        db.delete_column('mailer_message', 'ready_to_send')
    ...
    models = {
        ...
        'mailer.message': {
            ...
            'ready_to_send': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
